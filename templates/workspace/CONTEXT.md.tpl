...
2. Trabalha conforme L2 instrui.
3. Ao transicionar (sub-stage ou stage): atualiza frontmatter + append em `history` + commit atômico.
4. Pre-commit hook valida atomicidade outputs ↔ frontmatter.
