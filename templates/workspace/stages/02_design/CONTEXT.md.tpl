...
| 6 | {{PROJECT_ROOT}}/workspaces/{{WORKSPACE}}/_config/CONTEXT.md | L3 | yes (ubiquitous language glossary, populated by stage 01) |
| 7 | {{PROJECT_ROOT}}/.icm-main/docs/decisions/ | L3 | conditional: read content of active ADRs listed in recon-report (filenames already indexed in 00). Read via worktree `.icm-main/`. |
...
| 11 | {{PROJECT_ROOT}}/workspaces/{{WORKSPACE}}/_references/superpowers-summary/writing-plans-200tok.md | L3 | yes |
| 12 | {{PROJECT_ROOT}}/workspaces/{{WORKSPACE}}/_config/xp-conventions.md | L3 | yes |
| 13 | {{PROJECT_ROOT}}/.icm-main/docs/lessons.md | L3 | conditional: exists if inherited or accumulated. Read via worktree `.icm-main/`. |
| 14 | {{PROJECT_ROOT}}/.icm-main/docs/tech_debt.md | L3 | conditional: exists if debt has been declared in prior iterations. Read via worktree `.icm-main/`. |
| 15 | {{PROJECT_ROOT}}/workspaces/{{WORKSPACE}}/stages/02_design/_kickoff.md | L4-kickoff | conditional: generated by the previous session. Absent in beta1/beta2 workspaces (4B legacy) or if this is the first session of the stage. |
...
| 18 | {{PROJECT_ROOT}}/workspaces/{{WORKSPACE}}/_references/runtime/wave-planner-algorithm.md | L3 | conditional: referenced in discovery → technical tasks mapping |
| 19 | {{PROJECT_ROOT}}/workspaces/{{WORKSPACE}}/_references/runtime/design-system.md | L3 | conditional: effective profile has `design_system_required: True` (currently: `app_web_frontend`, `fullstack`) |
| 20 | {{PROJECT_ROOT}}/.icm-main/DESIGN.md | L3 | conditional: profile with `design_system_required: True` AND brownfield (file already exists). Read via worktree `.icm-main/`. |
