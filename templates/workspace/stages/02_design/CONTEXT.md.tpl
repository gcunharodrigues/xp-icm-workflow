...
3. **Map discovery → technical tasks:** break the macro option chosen in 01 into a list of discrete tasks. Each task fits into ≤1 wave of the Wave Planner (see `references/wave-planner-algorithm.md` — under construction, Wave 4 of the skill). **Consult `research.md`** (Input #5) for current data on stack versions, API pricing, library stats, and service costs when making design decisions — use concrete numbers with source URLs, not training memory.
