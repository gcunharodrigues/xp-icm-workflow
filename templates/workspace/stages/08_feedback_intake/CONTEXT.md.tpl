...
| 12 | {{LOGS_ROOT}} | L3 | conditional: sample of last 30 days if L0 declares `logs_root` ≠ null |
...
5. Persistent failure / human cancellation → stop point #15 `runtime_cleanup_failed`. Status `BLOCKED_STOP_POINT`.
